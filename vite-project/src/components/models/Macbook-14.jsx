...
Files: macbook-14.glb [629.72KB] > /Users/rohanjayatilake/Documents/Github/3D_Macbook_Landing/vite-project/public/Assets/models/macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacBookModel14(props) {
  ...
  const { nodes, materials, scene } = useGLTF('/Assets/models/macbook-14-transformed.glb');

  const texture = useTexture('/Assets/screen.png');
...
useGLTF.preload('/Assets/models/macbook-14-transformed.glb')
